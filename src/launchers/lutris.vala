namespace ProtonPlus.Launchers {
    public class Lutris {
        static Models.Group[] get_groups (Models.Launcher launcher) {
            ...
            groups[0].description = _("Compatibility tools for running Windows software on Linux.");
            ...
            groups[2].description = _("Variant of Wine's VKD3D which aims to implement the full Direct3D 12 API on top of Vulkan.");
