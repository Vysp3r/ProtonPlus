namespace ProtonPlus.Widgets.Games.LaunchOptionsEditor.Groups {
    ...
    public class GpuVendorAmdOptionsGroup : BaseOptionsGroup {
        ...
        public GpuVendorAmdOptionsGroup (owned SimpleCallback standard_control_changed, LaunchOptionsList launch_option_handlers) {
            ...
            amd_mesa_shader_cache_disable_tile = create_tile (_ ("Disable Mesa shader cache"), _ ("Disables Mesa's shader cache which can cause stuttering in some games."), { "MESA_SHADER_CACHE_DISABLE=1" });
