namespace ProtonPlus.Widgets {
    public abstract class ReleaseRow : Adw.ActionRow {
        ...
        public Widgets.ReleaseRowButton btn_cancel { get; set; }
        public Widgets.ReleaseRowButton btn_remove { get; set; }
        public Widgets.ReleaseRowButton btn_install { get; set; }
        ...
        construct {
            ...
            btn_cancel = new Widgets.ReleaseRowButton ("x-symbolic", _("Cancel the installation"));

            btn_remove = new Widgets.ReleaseRowButton ("trash-symbolic", _("Delete %s").printf (title));

            btn_install = new Widgets.ReleaseRowButton ("download-symbolic", _("Install %s").printf (title));
