namespace Models {
    public class Tool : Object, Interfaces.IModel {
        ...
        public enum TitleType {
            ...
            HGL, // A custom title specfic to Heroic Games Launcher
        ...
        public static GLib.List<Tool> HeroicWine () {
            ...
            tools.append (new Tool ("Wine-GE", "Compatibility tool \"Wine\" to run Windows games on Linux. Based on Valve Proton Experimental's bleeding-edge Wine, built for Lutris.Use this when you don't know what to choose.", "https://api.github.com/repos/GloriousEggroll/wine-ge-custom/releases", 1, TitleType.HGL));
        ...
        public static GLib.List<Tool> HeroicProton () {
            ...
            tools.append (new Tool ("Proton-GE", "Steam compatibility tool for running Windows games with improvements over Valve's default Proton. Use this when you don't know what to choose.", "https://api.github.com/repos/GloriousEggroll/proton-ge-custom/releases", 1, TitleType.HGL));
