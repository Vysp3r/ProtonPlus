    ...
    public class VariantCompatibility : Object {
        ...
        public static VariantCompatibility for_architectures (CpuArchitecture[] architectures) {
            foreach (var architecture in architectures) {
                if (architecture == CpuArchitecture.X86_64)
                    return new VariantCompatibility (architectures, X86_64Level.BASELINE);
            }
            return new VariantCompatibility (architectures);
        }
        ...
        public bool is_compatible_with (CpuCapabilities capabilities) {
            // An uncertain probe must never make a variant disappear.
            ...
            return capabilities.architecture != CpuArchitecture.X86_64 ||
                   minimum_x86_64_level == X86_64Level.UNKNOWN ||
                   capabilities.supports_x86_64_level (minimum_x86_64_level);
        }
        ...
        public static VariantCompatibility from_json (Json.Object? obj) {
            ...
            var compatibility = new VariantCompatibility (parsed_architectures, level, architecture_independent);
