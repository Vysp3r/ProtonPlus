namespace AppTests.ControllerHintPolicyTest {
    ...
    private ControllerHintKind[] hints_for (ControllerHintControlKind control =
        ...
        bool popover = false, bool active = true) {
    ...
    private void assert_mapping (SDL.Gamepad.GamepadButtonLabel south,
        SDL.Gamepad.GamepadButtonLabel east, ControllerPhysicalButtonLabel expected_south,
        ControllerPhysicalButtonLabel expected_east) {
        var facts = ControllerPhysicalLabelResolver.from_sdl (south, east);
